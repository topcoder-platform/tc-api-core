 ...
 * 
 */
package com.topcoder.core.api.v3.dropwizard;
...
import com.topcoder.core.api.v3.exception.ResourceInitializationException;
import com.topcoder.core.api.v3.model.annotation.ApiJacksonAnnotationIntrospector;
import com.topcoder.core.api.v3.request.inject.FieldSelectorProvider;
import com.topcoder.core.api.v3.request.inject.QueryParameterProvider;
import com.topcoder.core.api.v3.response.ApiResponseFilter;
import com.topcoder.core.auth.AllowAnonymousFeature;
import com.topcoder.core.auth.AuthUser;
import com.topcoder.core.auth.JWTAuthProvider;
import com.topcoder.core.auth.JWTAuthenticator;
...
public class APIApplication<T extends APIBaseConfiguration> extends Application<T> {
	...
	protected List<Object> getAllResources() throws Exception {
		Reflections reflections = new Reflections("com.topcoder");
